...
const DeferredPaymentLoan = () => {
    const [value, onChangeText] = useState('');
    const [type, setType] = React.useState("Monthly APR");
return (
    <View style={styles.container}>
    <Text style={[styles.text,{marginTop: 20, marginBottom:10}]}>Deferred Payment Loan</Text>
    <Text>Paying Back a Lump Sum Due at Maturity</Text>
...
export default DeferredPaymentLoan;
